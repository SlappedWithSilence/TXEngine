...
public class CombatEngineTest {
    ...
    public void getTurnOrder() {
        ...
        friendlies.add(new CombatEntity("F1", "", "", 1, new Inventory(), new AbilityManager(), new CombatResourceManager(), new EquipmentManager(), 1, 5));
        friendlies.add(new CombatEntity("F2", "", "", 1, new Inventory(), new AbilityManager(), new CombatResourceManager(),  new EquipmentManager(),2, 5));

        enemies.add(new CombatEntity("E1", "", "", 1, new Inventory(), new AbilityManager(), new CombatResourceManager(), new EquipmentManager(), 3, 5));
        enemies.add(new CombatEntity("E2", "", "", 1, new Inventory(), new AbilityManager(), new CombatResourceManager(),  new EquipmentManager(),4, 50));
